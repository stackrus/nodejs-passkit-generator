    ...
    <div className="main-page">
      <div className="flex flex-col items-center">
        ...
        <button
          ...
          disabled={isLoading}
          type="button"
          className="w-[18rem] rounded-lg border border-blue-500 bg-blue-500 px-5 py-2.5 text-center text-sm font-medium text-white shadow-sm transition-all hover:border-blue-700 hover:bg-blue-700 focus:ring focus:ring-blue-200 disabled:cursor-not-allowed disabled:border-blue-300 disabled:bg-blue-300"
        >
          Generate a passkit
        </button>
      </div>
